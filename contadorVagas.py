...
while True:
    ...
    imgTh = cv2.adaptiveThreshold(imgCinza,255,cv2.ADAPTATIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY_INV,25,16)
    ...
    for x,y,w,h in vagas:
        ...
        cv2.putText(img,str(qtTxBranco),(x,y+h-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),1)
